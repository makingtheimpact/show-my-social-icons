...
class SMSI_All_Icons_Widget extends WP_Widget {
    public function __construct() {
        parent::__construct(
            ...
            '(All Icons) Show My Social Icons',
    ...
    public function widget($args, $instance) {
        ...
        echo do_shortcode(sprintf(
            '[show_my_social_icons type="%s" size="%s" style="%s" alignment="%s" custom_color="%s" margin_top="%s" margin_right="%s" margin_bottom="%s" margin_left="%s" spacing="%s"]',
            $icon_type,
            $icon_size,
            $icon_style,
            $icon_alignment,
