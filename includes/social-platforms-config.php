...
$social_platforms = [
    ...
    'landlinephone' => [
        'platform_id'    => 'landlinephone',
        'label' => 'Landline Phone',
        'default_order' => 20,
    ],
    'librarything' => [
        'platform_id'    => 'librarything',
        'label' => 'LibraryThing',
        'default_order' => 21,
    ],
    'linkedin' => [
